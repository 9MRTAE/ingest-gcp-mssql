...
Run all tables (normal / scheduled):
    python -m flows.ingest_gcp_mssql_erp

Repair single table:
    python -m flows.ingest_gcp_mssql_erp --table tmCOR
    python -m flows.ingest_gcp_mssql_erp --table tmCOR --backdate -3
    python -m flows.ingest_gcp_mssql_erp --table tmCOR --startdate 2024-01-01 --enddate 2024-01-31
"""
