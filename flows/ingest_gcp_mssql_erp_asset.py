"""
Flow  : ingest_gcp_mssql_erp_asset
...
Run all tables (normal / scheduled):
    python -m flows.ingest_gcp_mssql_erp_asset

Repair single table:
    python -m flows.ingest_gcp_mssql_erp_asset --table <TABLE_NAME>
    python -m flows.ingest_gcp_mssql_erp_asset --table <TABLE_NAME> --backdate -3
"""
