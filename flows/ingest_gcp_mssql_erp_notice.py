"""
Flow  : ingest_gcp_mssql_erp_notice
...
Run all tables (normal / scheduled):
    python -m flows.ingest_gcp_mssql_erp_notice

Repair single table:
    python -m flows.ingest_gcp_mssql_erp_notice --table <TABLE_NAME>
    python -m flows.ingest_gcp_mssql_erp_notice --table <TABLE_NAME> --backdate -3
"""
