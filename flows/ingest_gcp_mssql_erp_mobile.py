"""
Flow  : ingest_gcp_mssql_erp_mobile
...
Run all tables (normal / scheduled):
    python -m flows.ingest_gcp_mssql_erp_mobile

Repair single table:
    python -m flows.ingest_gcp_mssql_erp_mobile --table <TABLE_NAME>
    python -m flows.ingest_gcp_mssql_erp_mobile --table <TABLE_NAME> --backdate -3
"""
