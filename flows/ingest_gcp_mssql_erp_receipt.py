"""
Flow  : ingest_gcp_mssql_erp_receipt
...
Run all tables (normal / scheduled):
    python -m flows.ingest_gcp_mssql_erp_receipt

Repair single table:
    python -m flows.ingest_gcp_mssql_erp_receipt --table <TABLE_NAME>
    python -m flows.ingest_gcp_mssql_erp_receipt --table <TABLE_NAME> --backdate -3
"""
