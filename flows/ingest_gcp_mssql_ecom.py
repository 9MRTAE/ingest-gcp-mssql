...
Run all tables (normal / scheduled):
    python -m flows.ingest_gcp_mssql_ecom

Repair single table:
    python -m flows.ingest_gcp_mssql_ecom --table tmAttribute
    python -m flows.ingest_gcp_mssql_ecom --table tmAttribute --backdate -3
    python -m flows.ingest_gcp_mssql_ecom --table tmAttribute --startdate 2024-01-01 --enddate 2024-01-31
"""
...
from registries.registry_ecom import TABLE_REGISTRY
