...
Run all tables (normal / scheduled):
    python -m flows.ingest_gcp_mssql_erp_gl

Repair single table:
    python -m flows.ingest_gcp_mssql_erp_gl --table <TABLE_NAME>
    python -m flows.ingest_gcp_mssql_erp_gl --table <TABLE_NAME> --backdate -3
"""
