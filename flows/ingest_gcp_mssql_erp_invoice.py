"""
Flow  : ingest_gcp_mssql_erp_invoice
...
Run all tables (normal / scheduled):
    python -m flows.ingest_gcp_mssql_erp_invoice

Repair single table:
    python -m flows.ingest_gcp_mssql_erp_invoice --table <TABLE_NAME>
    python -m flows.ingest_gcp_mssql_erp_invoice --table <TABLE_NAME> --backdate -3
"""
