"""
Flow  : ingest_gcp_mssql_erp_product
...
Run all tables (normal / scheduled):
    python -m flows.ingest_gcp_mssql_erp_product

Repair single table:
    python -m flows.ingest_gcp_mssql_erp_product --table <TABLE_NAME>
    python -m flows.ingest_gcp_mssql_erp_product --table <TABLE_NAME> --backdate -3
"""
